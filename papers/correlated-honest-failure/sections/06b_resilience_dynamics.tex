...
X_t=(C_t,O_t,R_t),
\]
where $C_t$ is a normalized fault-specific independently corrective capacity, $O_t$ is maintenance observability or attribution capacity, and $R_t$ is returned-resource capacity. Consider the declared linear update
\begin{align}
